				...
				case 2:
					...
					switch(option2)
					{
						case 1:
							...
							if(p1 != null)
							{
								System.out.println("Payment Inserted.... Payment Id: " + p1.getPaymentId());
							}
							else
							{
								System.out.println("Payment NOT Inserted.... Payment Id: " + p1.getPaymentId());
							}
							System.out.println();
							break;
					...
					switch(option4)
					{
						case 1:
							...
							if(ms.insertMedicine(I1))
							{
								...
								String msg = "Medicine Inserted.... customer Medicine ID: " + I1.getMedID();
								frwd.writeInFile(msg);
							}
							else
							{
								System.out.println("Medicine NOT Inserted.... customer Medicine Id: " + I1.getMedID());
							}
							System.out.println();
							break;
